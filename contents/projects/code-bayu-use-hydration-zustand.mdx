...
```bash
# npm
npm install @codesofyan/use-hydration-zustand

# yarn
yarn add @codesofyan/use-hydration-zustand
```
...
This project is licensed under the [MIT License](https://opensource.org/licenses/MIT) - see the [LICENSE](https://github.com/codesofyan/use-hydration-zustand/blob/main/LICENSE) file for details.
